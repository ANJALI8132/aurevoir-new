    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./createplan">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./activeuser">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./upcoming">
              <i class="material-icons">supervisor_account</i>
              <p>Upcoming Expiry User List</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="./expired">
              <i class="material-icons">supervisor_account</i>
              <p>Expired User List</p>
            </a>
          </li>
          <li class="nav-item ">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">User Creation</a>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" name="form1" action="{{URL::to('/createuser')}}">
                  ...
                  -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Sales Agent</label>
                          <select name="salesagent" class="form-control">
                            <option value=""> --Select Agent-- </option>
                            <option value="1">Cyril</option>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit">Create User</button>
