      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Bill Generation</a>
          </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="./password">Settings</a>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Create bill</p>
                </div>
                <div class="card-body">
                  ...
                  -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Amount + Tax</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit">Generate Bill</button>
